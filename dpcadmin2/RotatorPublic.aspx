<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RotatorPublic.aspx.cs" Inherits="RotatorPublic" %>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="RotatorPublic.aspx">View Public Link</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
