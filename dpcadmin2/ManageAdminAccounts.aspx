<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageAdminAccounts.aspx.cs" Inherits="ManageAdminAccounts" %>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="ManageProducts.aspx">Insert New Product</a></li>
            <li><a href="EditProducts.aspx">Edit Products</a></li>
          </ul>
        </li>
          <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="ManageAdminAccounts.aspx">Manage Admin Accounts</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">View Admin Accounts</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Create New Admin Accounts</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
              <div class="box-body">
               <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="inputProduct" placeholder="Item Name">
                </div>
                <div class="form-group">
                  <label for="inoutid">Item ID</label>
                  <input type="text" class="form-control" id="inputID" placeholder="Item ID">
                </div>
                <div class="form-group">
                  <label>Item Category</label>
                  <select class="form-control">
                    <option>Please Select A Item Category</option>
                  ...
                  <select class="form-control">
                    <option>Please Select A Item Status</option>
               ...
               <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" placeholder="Please Enter Item Description"></textarea>
                </div>
                <div class="form-group">
                  <label>Item Notes</label>
                  <textarea class="form-control" rows="3" placeholder="Please Enter Item Notes"></textarea>
                </div>
                <div class="form-group">
