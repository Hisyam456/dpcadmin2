<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditRotator.aspx.cs" Inherits="EditRotator" %>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="col-xs-12">
          <div class="box">
           ...
           <div class="box-header">
              <h3 class="box-title">Rotator Images</h3>
            </div>
            <!-- /.box-header -->
        ...
        <ContentTemplate>
             <asp:GridView ID="gvrtImageState" runat="server"  CssClass="gvv responsive display table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowDeleting="gvrtImageState_RowDeleting">
                   <Columns>
                     ...
                     <asp:TemplateField HeaderText="Rototaor Image Name" HeaderStyle-HorizontalAlign="Center">
                       <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("rmName") %>'></asp:Label>
                       </ItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="Category" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblCat" runat="server" Text='<%# Eval("rmCat") %>'></asp:Label>
                       ...
                       <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("rmStatus") %>'></asp:Label>
                       ...
                       <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblDesc" runat="server" Text='<%# Eval("rmDesc") %>'></asp:Label>
                             <ItemStyle HorizontalAlign="Center" Width="15%" />
                          </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Notes" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblNotes" runat="server" Text='<%# Eval("rmNotes") %>'></asp:Label>
                             <ItemStyle HorizontalAlign="Center" Width="15%" />
                          </ItemTemplate>
                       ...
                       <asp:TemplateField HeaderText="Image 5" HeaderStyle-HorizontalAlign="Center">
                        ...
                        <asp:TemplateField HeaderText="Edit Product" >
                         <ItemTemplate>  
                             <asp:HyperLink runat="server" class="btn btn-block btn-primary btn-sm" Text="Edit"  NavigateUrl='<%# "../" + "EditRotatorImage.aspx?rotatorID=" + Eval("rmID")%>'></asp:HyperLink>
                         </ItemTemplate>
                           <ItemStyle HorizontalAlign="Left" Width="5%" />
                      </asp:TemplateField>

                       <asp:TemplateField HeaderText="Delete Rotator Image" >
                         <ItemTemplate>  
                             <asp:Button ID="btnDll" runat="server" Text="Delete" CommandName="Delete" class="btn btn-block btn-danger btn-sm" OnClientClick="return isDelete()"/>
