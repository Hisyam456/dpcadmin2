<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadRotator.aspx.cs" Inherits="UploadRotator" %>
...
<form id="rotatorImageForm" runat="server">
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="UploadRotator.aspx">Upload Rotator Items</a></li>
        ...
        <div class="row">
           ...
           <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Upload Rotator Images</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                  ...
                  <label for="exampleInputEmail1">Item Name</label>
                   <asp:TextBox ID="rtIname" placeholder="Rotator Image Name" type="text" runat="server" class="form-control"></asp:TextBox>
                </div>             
                <div class="form-group">
                  <label>Item Category</label>
                  <asp:DropDownList ID="rtiCat" runat="server" class="form-control">
                ...
                <div class="form-group">
                  <label>Item Satus</label>
                   <asp:DropDownList ID="rtiStats" runat="server" class="form-control">
                ...
                <div class="form-group">
                  <label>Item Description</label>
                   <asp:TextBox ID="rtiDesc" runat="server" TextMode="MultiLine" class="form-control" placeholder="Please Enter Item Description"></asp:TextBox>
                </div>
                <div class="form-group">
                  <label>Item Notes</label>
                  <asp:TextBox ID="rtiNotes" runat="server" TextMode="MultiLine" class="form-control" placeholder="Please Enter Item Notes"></asp:TextBox>
                </div>
                  </div>
                <div class="col-md-6">
                  <div class="form-group">
                  <label for="exampleInputFile">Image 1-6 Upload</label>        
                 <asp:FileUpload ID="FileUpload1" runat="server" class="multi" accept="png|jpg" Multiple="Multiple" maxlength="6"/>
                  <p class="help-block">Only Select 6 images to upload | Format in PNG/JPG</p>
                </div>
              ...
              <div class="box-footer">
                <asp:Button ID="btnSubmit" runat="server" Text="Submit" type="submit" OnClick="submitrti_Click" class="btn btn-primary"/>
              </div>
