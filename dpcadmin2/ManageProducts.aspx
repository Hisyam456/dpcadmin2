...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <ContentTemplate>
            <asp:GridView ID="gvProductState" runat="server"  CssClass="gvv responsive display table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowDeleting="gvProductState_RowDeleting">
                   <Columns>
                     ...
                     <asp:TemplateField HeaderText="Category" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblPrice" runat="server" Text='<%# Eval("pCat") %>'></asp:Label>
                       ...
                       <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblDesc" runat="server" Text='<%# Eval("pDesc") %>'></asp:Label>
                             <ItemStyle HorizontalAlign="Center" Width="15%" />
                          </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Notes" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblNotes" runat="server" Text='<%# Eval("pNotes") %>'></asp:Label>
                             <ItemStyle HorizontalAlign="Center" Width="15%" />
                          </ItemTemplate>
                       ...
                       <asp:TemplateField HeaderText="Image" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                              ...
                              <asp:Image ID="Image1" runat="server" Height="122px" ImageUrl='<%# Eval("pImage")%>' Width="148px" />
                        ...
                        <asp:TemplateField HeaderText="Edit Product" >
                         <ItemTemplate>  
                             <asp:HyperLink runat="server" class="btn btn-block btn-primary btn-sm" Text="Edit"  NavigateUrl='<%# "../" + "EditProducts.aspx?productID=" + Eval("pID")%>'></asp:HyperLink>
                         </ItemTemplate>
                           <ItemStyle HorizontalAlign="Left" Width="5%" />
                      </asp:TemplateField>
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-footer">
                  <asp:Button ID="btnSubmit" runat="server" Text="Submit" type="submit" OnClick="submitbtn_Click" class="btn btn-primary"/>
