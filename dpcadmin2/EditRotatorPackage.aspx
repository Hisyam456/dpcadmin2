<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditRotatorPackage.aspx.cs" Inherits="EditRotatorPackage" %>
...
<body class="hold-transition skin-blue sidebar-mini">
    <form id="editRotator" runat="server">
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <ContentTemplate>
            <asp:GridView ID="gvPackagestate" runat="server"  CssClass="gvv responsive display table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowDeleting="gvPackagestate_RowDeleting">
                   <Columns>
                   
                     
                      <asp:TemplateField HeaderText="ID" >
                         <ItemTemplate>
                            <asp:Label ID="lblrpID" runat="server" Text='<%# Eval("rpID") %>'></asp:Label>
                         </ItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="Package Name" HeaderStyle-HorizontalAlign="Center">
                       <ItemTemplate>
                            <asp:Label ID="lblName" runat="server" Text='<%# Eval("rpName") %>'></asp:Label>
                       </ItemTemplate>
                      <ItemStyle HorizontalAlign="Left" Width="18%" />
                     </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="Email" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblPrice" runat="server" Text='<%# Eval("rpEmail") %>'></asp:Label>
                       ...
                       <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("rpStatus") %>'></asp:Label>
                       ...
                       <asp:TemplateField HeaderText="Access" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
                            <asp:Label ID="lblAccess" runat="server" Text='<%# Eval("rpAccess") %>'></asp:Label>
                             <ItemStyle HorizontalAlign="Center" Width="18%" />
                          </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Edit Package" >
                         <ItemTemplate>  
                             <asp:HyperLink runat="server" class="btn btn-block btn-primary btn-sm" Text="Edit"  NavigateUrl='<%# "../" + "EditPackage.aspx?packageID=" + Eval("rpID")%>'></asp:HyperLink>
                         </ItemTemplate>
                           <ItemStyle HorizontalAlign="Left" Width="10%" />
                      </asp:TemplateField>

                        <asp:TemplateField HeaderText="Delete Rotator Package" >
                         <ItemTemplate>  
                             <asp:Button ID="btnDlp" runat="server" Text="Delete" CommandName="Delete" class="btn btn-block btn-danger btn-sm" OnClientClick="return isDelete()"/>
