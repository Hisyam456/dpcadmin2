          ...
          <div class="box-header with-border">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
               ...
               <div class="col-md-12">
            <div class="box-body">
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="awID" DataSourceID="SqlDataSource1" class="responsive display table table-striped table-bordered table-hover dataTable no-footer">

                                   <Columns>
                                       
                        <asp:TemplateField HeaderText="Item Image" HeaderStyle-HorizontalAlign="Center">
                         <ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DesignPackagingConceptConnectionString %>" SelectCommand="SELECT * FROM [dpcAwards] WHERE ([awID] = @awID)">
                <SelectParameters>
                    <asp:QueryStringParameter Name="awID" QueryStringField="awardID" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
          </div>
              ...
              <div class="box-footer" style="text-align: -webkit-right;">
                  <asp:Button ID="btnSubmit" runat="server" Text="Edit Award Details" type="submit"  OnClick="updateDetailsaward_Click"  class="btn btn-primary"/>
              ...
              <h3 class="box-title">Edit Rotator Images</h3>
                ...
                <div class="form-group">
                 ...
                 <div class="box-footer">
                  <asp:Button ID="btnImageSubmit" runat="server" Text="Edit Award Image" type="submit" OnClick="updateawardPic_Click"  class="btn btn-primary"/>
                </div>
              </div>
             </div>
          <!-- /.box -->
